...
urlpatterns = patterns('parametros.views',
    ...
    url(r'^plan_pago/listado/$', 'consultar_plan_de_pago', name='frontend_plan_pago_listado'),
    ...
    url(r'^plan_pago_vendedores/listado/$', 'consultar_plan_de_pago_vendedores', name='frontend_plan_pago_vendedores_listado'),
    url(r'^plan_pago/listado_busqueda_ppagos_vendedores/$', 'listar_busqueda_ppagos_vendedores'),
    url(r'^plan_pago/listado_busqueda_ppagos_vendedores/(?P<plandepago_vendedor_id>\d+)/$', 'detalle_plan_de_pago_vendedores'),
    ...
    url(r'^timbrado/listado/$', 'consultar_timbrado', name='frontend_timbrado_listado'),
    url(r'^timbrado/listado/(?P<timbrado_id>\d+)/$', 'detalle_timbrado'),
    url(r'^timbrado/listado_busqueda_timbrado/$', 'listar_busqueda_timbrado'),
    url(r'^timbrado/listado_busqueda_timbrado/(?P<timbrado_id>\d+)/$', 'detalle_timbrado'),
    url(r'^timbrado/agregar/$', 'agregar_timbrado'),
    
    url(r'^concepto_factura/$', 'concepto_factura'),
    url(r'^concepto_factura/listado/$', 'consultar_concepto_factura', name='frontend_concepto_factura_listado' ),
    ...
    url(r'^concepto_factura/listado_busqueda_concepto_factura/(?P<concepto_factura_id>\d+)/$', 'detalle_concepto_factura'),
    ...
    url(r'^timbrado/listado/(?P<timbrado_id>\d+)/rango_factura/listado/$', 'consultar_rango_factura', name='frontend_rango_factura_listado'),
    url(r'^timbrado/listado/(?P<timbrado_id>\d+)/rango_factura/listado/(?P<rango_factura_id>\d+)/(?P<usuario_id>\d+)/$', 'detalle_rango_factura'),
