                    ...
                    try:             
                        ...
                        if tipo_busqueda == "fraccion":
                            ...
                            try:
                                ...
                                #===============================================
                                pagos=[]
                                pago_de_cuotas_ventas = PagoDeCuotas.objects.filter(venta__in=ventas_id,fecha_de_pago__range=(fecha_ini_parsed, fecha_fin_parsed)).order_by('fecha_de_pago').prefetch_related('venta')
