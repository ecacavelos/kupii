...
urlpatterns = patterns('informes.views',    
    ...
    url(r'^proximos_vencimientos/$', 'proximos_vencimientos', name='frontend_proximos_vencimientos'),
    url(r'^deudores_por_venta/$', 'deudores_por_venta', name='frontend_deudores_por_venta'),
    ...
    url(r'^deudores_por_venta_reporte_excel/$', 'deudores_por_venta_reporte_excel'),
    url(r'^proximos_vencimientos_reporte_excel/$', 'proximos_vencimientos_reporte_excel'),
